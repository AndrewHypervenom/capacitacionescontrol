export function MergeGuide() {
  return (
    <section className="bg-slate-900 rounded-2xl shadow-sm border border-slate-800 p-6">
      ...
      <ol className="list-decimal list-inside text-sm text-slate-300 space-y-2 mt-3">
        <li>
          <b>Antes de tocar un archivo</b>, márcalo aquí con tu rama. Así los demás saben
          que es tuyo.
        </li>
        <li>
          Si ves una <span className="text-rose-400 font-semibold">alerta roja</span>,
        ...
        <li>
          ...
          <code className="bg-slate-800 px-1 rounded">main → isa → paola</code>. Hagan{" "}
          <code className="bg-slate-800 px-1 rounded">git pull origin main</code> en su rama{" "}
