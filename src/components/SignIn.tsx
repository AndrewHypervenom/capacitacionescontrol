...
export function SignIn() {
  ...
  return (
    <main className="max-w-md mx-auto px-5 py-16">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center fade-in">
        ...
        <button
          onClick={() => void handle()}
          disabled={loading}
          className="mt-6 w-full inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 active:scale-95 transition text-white font-semibold rounded-lg px-4 py-3 disabled:opacity-50"
        >
