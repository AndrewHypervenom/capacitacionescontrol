  ...
  return (
    <section className="space-y-3">
      {alerts.map((a) => (
        <div
          key={a.file}
          className="bg-rose-950/40 border border-rose-800 rounded-xl p-4 fade-in"
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="font-bold text-rose-200">
                ...
                <code className="bg-rose-900/60 px-1 rounded">{a.file}</code>
              </p>
              ...
              <div className="flex flex-wrap gap-1.5 mt-2">
                {a.rows.map((r) => (
                  <span
                    key={r._id}
                    className="inline-flex items-center gap-1 bg-slate-800/70 text-slate-100 rounded-full px-2 py-0.5 text-xs font-medium"
                  >
                    <span
                    ...
                    />
                    {r.userName}
                    <span className="text-rose-400">· {r.branch}</span>
                  </span>
                ))}
              </div>
              <p className="text-sm text-rose-200 mt-2">
                ...
                persona espera, hace{" "}
                <code className="bg-rose-900/60 px-1 rounded">git pull</code> y luego edita.
